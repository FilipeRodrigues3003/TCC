    ...
    transform: translate(-50%, 0%);">
        ...
        <div class="container">
            <?php
                ...
                $data = alunos_from_turma(id_from_nome_turma($turma, base64_decode($_GET['q']), $_SESSION['usuario']));
                $i = 1;
                echo ('<form action="../model/edit.php?turma='. $_GET["turma"] .'&q='.$_GET['q'].'" method="POST">');
    	 ...
    	 <div class="input-group-prepend "> <span class="input-group-text bg-secundary text-muted " id="basic-addon1">##</span> </div>
               <input type="text" name="mat" class="form-control bg-secundary col-3 border-right-0" value="Matricula" onclick="alert();" disabled readonly> <input type="text" name="nom" class="form-control bg-secundary border-left-0" value="Nome" disabled readonly></div>');
                foreach ($data as $row) {
                    $nome = $row[0];
                    $matricula = $row[1];
                    echo ('   
                    <div class="control-group input-group" style="margin-top:10px">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1">' .  sprintf("%02d", $i) . '</span>
                        </div>
                        
                        <input type="text" name="aluno_mat[]" class="form-control input-aluno  bg-light col-3 border-right-0" value="' . $matricula . '" require>
                        <input type="text" name="aluno_nome[]" class="form-control input-aluno  bg-light border-left-0" value="' . $nome . '" require>
            ...
            ');
                ...
                echo (' <div class="copy d-none">
                        <div class="control-group input-group" style="margin-top:10px">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="material-icons">add</i></span>
                            </div>
                            <input type="text" name="aluno[]" class="form-control col-3 input-aluno" placeholder="Matricula do Aluno" require> <input type="text" placeholder="Nome do Aluno" name="nome[]" class="form-control bg-secundary border-left-0" require>
                            <div class="input-group-append">
                                <button class="btn btn-danger remove" type="button">
                                    <i class="material-icons">clear</i>
                                    Remover
        ...
        ');
                ...
                <div class="input-group control-group after-add-more d-block">
                    ...
                    <div class="input-group-btn btn-group">
                        ...
                        <button class="btn btn-success d-block add-more btn-cad" type="button">
        ...
        <div class="btn-group" style="margin-top: 5%;">
            <button class="btn btn-dark" type="button" onclick="gerenciar('<?php echo($_GET['q']); ?>');"><i class="material-icons">arrow_back</i>
                Voltar</button>
            <button class="btn btn-info" type="submit" id="<?php echo ($turma); ?>" name="envia">
   ...
   <footer id="footer">
		<nav class="navbar navbar-dark bg-dark">
			...
			<ol class="breadcrumb bg-dark" style="margin-bottom: -5px;">
                ...
                <li class="breadcrumb-item active" aria-current="page">Editar Alunos</li>
              </ol>
